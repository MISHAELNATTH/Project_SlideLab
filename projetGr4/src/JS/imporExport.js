...
function exportCurrentSlide() {
  ...
  const htmlDoc = document.implementation.createHTMLDocument("Slide Export");

  // --- CSS minimal pour que les éléments soient visibles ---
  ...
  slide.elements.forEach(el => {
    ...
    div.classList.add("slide-element", `${el.type}-element`);
...
<button id="exportSlideBtn">Exporter Slide</button>
document.getElementById("exportSlideBtn").addEventListener("click", () => {
  exportCurrentSlide();
});
